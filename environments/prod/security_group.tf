...
# Application Tier -> NAT
resource "aws_vpc_security_group_ingress_rule" "nat_app_private_a" {
  security_group_id = aws_security_group.nat.id

  cidr_ipv4   = "10.23.31.0/24"
  ip_protocol = "-1"
}

resource "aws_vpc_security_group_ingress_rule" "nat_app_private_c" {
  security_group_id = aws_security_group.nat.id

  cidr_ipv4   = "10.23.32.0/24"
  ip_protocol = "-1"
}
